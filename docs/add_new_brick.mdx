...
next: /index.mdx
nextTitle: Die CLI
previous: /brick_setups/firebase_crashlytics_setup.mdx
...
Deshalb solltest du *ALLE* Tests deines Features innerhalb deines Bricks in einen Ordner ```test``` packen (den Ordner kannst du auch anders nennen, mehr dazu unter **Neue Creation Option in die CLI einfügen**) und innerhalb dieses Ordners die Brickstruktur nachbauen.
